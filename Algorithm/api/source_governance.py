...
_SOURCE_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "yfinance": {
        ...
        "required_env_keys": [],
        "governance_status": GOVERNANCE_REQUIRES_COMMERCIAL_REVIEW,
        "fallback_role": "primary_free_provider",
        "criticality": "high",
        "notes": [
            "Primary free market data provider — no API key, works from any cloud server.",
            "Promoted from dev-only to production use; no API key means no Railway failures.",
        ],
    },
    "google_news_rss": {
