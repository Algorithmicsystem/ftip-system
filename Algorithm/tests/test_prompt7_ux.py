...
class TestVersion32:
    ...
    def test_config_client_version_is_32(self):
        ...
        assert r.json()["version"] in ("32.0.0", "33.0.0", "34.0.0", "1.0.0", "1.0.1", "1.0.2")

    def test_index_html_cache_bust_is_v32(self):
        html = (WEBAPP / "index.html").read_text()
        assert "?v=32" in html or "?v=33" in html or "?v=34" in html or "?v=100" in html or "?v=101" in html or "?v=102" in html
    ...
    def test_at_least_17_v32_references_in_html(self):
        html = (WEBAPP / "index.html").read_text()
        count = html.count("?v=32") + html.count("?v=33") + html.count("?v=34") + html.count("?v=100") + html.count("?v=101") + html.count("?v=102")
