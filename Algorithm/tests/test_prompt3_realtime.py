...
class TestVersionBump:
    def test_version_bumped_to_29(self):
        ...
        assert any(v in version for v in ("29", "30", "31", "32", "33", "34")), f"Expected version >=29, got {version}"

    def test_html_version_29(self):
        html = (WEBAPP_DIR / "index.html").read_text()
        assert "v=29" in html or "v=30" in html or "v=31" in html or "v=32" in html or "v=33" in html or "v=34" in html
