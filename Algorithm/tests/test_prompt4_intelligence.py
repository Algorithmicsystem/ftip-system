...
class TestVersionBump:
    def test_main_version_29(self):
        ...
        assert "34.0.0" in src or "33.0.0" in src or "32.0.0" in src or "31.0.0" in src or "1.0.0" in src or "1.0.1" in src or "1.0.2" in src or "1.0.3" in src
    ...
    def test_index_html_v29(self):
        ...
        assert "?v=29" in html or "?v=30" in html or "?v=31" in html or "?v=32" in html or "?v=33" in html or "?v=34" in html or "?v=100" in html or "?v=101" in html or "?v=102" in html or "?v=103" in html
