...
def compute_superfactor(alpha_series: pd.Series, sentiment: pd.Series, crowd_accel: pd.Series, regime_score: pd.Series, momentum: pd.Series) -> pd.Series:
    aligned = pd.concat([alpha_series, sentiment, crowd_accel, regime_score, momentum], axis=1).fillna(0.0)
